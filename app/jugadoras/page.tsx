      ...
      <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
          ...
          <SummaryCard
            ...
            value={
              nextBirthdayPlayer
                ? `${nextBirthdayPlayer.nickname ?? nextBirthdayPlayer.name} · ${nextBirthdayPlayer.nextBirthday.toLocaleDateString("es-AR", {
                    day: "2-digit",
                    month: "2-digit",
                  })}`
                : "-"
            ...
            {sortedPlayerSummaries.map((player) => (
              ...
              >
                ...
                <div className="mt-4 space-y-2 text-sm text-[var(--muted)]">
                  ...
                  <p>
                    <span className="font-medium text-[var(--foreground)]">Cumpleaños:</span>{" "}
                    {player.birthDate ?? "-"}
                  </p>
                  <p>
